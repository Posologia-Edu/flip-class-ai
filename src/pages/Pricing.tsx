...
const planFeatures: Record<PlanKey, string[]> = {
  ...
  professor: [
    ...
    "Analytics por sala (engajamento, desempenho por questão, alunos em risco)",
    "Revisão por pares",
  ...
  institutional: [
    ...
    "Analytics cruzado entre salas (comparação de conclusão, média, alertas de baixa performance)",
