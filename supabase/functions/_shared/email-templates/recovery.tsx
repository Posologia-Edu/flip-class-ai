...
export const RecoveryEmail = ({
  ...
  <Html lang="pt-BR" dir="ltr">
    <Head />
    <Preview>Redefinir sua senha no FlipClass</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Recebemos uma solicitação para redefinir sua senha no FlipClass. Clique no botão abaixo para criar uma nova senha.
        </Text>
